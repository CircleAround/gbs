    ...
    <div id="left">
            ...
            <?php foreach ($thread->comments as $comment): ?>
                  <?php if (!empty($current_user) && $comment->actor_id == $user['id']) { ?>
                    <div class="boxR">
                        <div class="boxInner">
                          <div class="updateList upWrap up_c_y">更新日時:<span class="time"><?= h($comment->updated_at) ?></span><span class="user"><?= h($user['name']) ?></span></div>
                ...
                <?php } else {?>
                    <div class="boxL">
                        <div class="boxInner">
                          <div class="updateList upWrap up_c_b">更新日時:<span class="time"><?= h($comment->updated_at) ?></span><span class="user"><?= h($user['name']) ?></span></div>
                            <p class="answerText"><?= h($comment->body) ?></p>
                        </div><!-- boxInner -->
                    </div><!-- boxL -->
                <?php } ?>
